...
class UserDetailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_detail" do
    assert_difference("UserDetail.count") do
      post user_details_url, params: { user_detail: { age: @user_detail.age, career: @user_detail.career, first_name: @user_detail.first_name, input_income: @user_detail.input_income, last_name: @user_detail.last_name } }
    end
  ...
  test "should update user_detail" do
    patch user_detail_url(@user_detail), params: { user_detail: { age: @user_detail.age, career: @user_detail.career, first_name: @user_detail.first_name, input_income: @user_detail.input_income, last_name: @user_detail.last_name } }
